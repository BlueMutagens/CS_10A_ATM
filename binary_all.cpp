...
int main()
{
    ...
    for(i = 0; !((2<<i)>start) ; i++) // finds the first power of 2 thats bigger than the starting number
    {}
    ...
    if((2<<i)>start) // when that power of two is found, the calculations can begin
        {
            ...
            cout<<(start/1)<<endl; // final division step. Tried to account for this in above while loop, but solution wouldn't work for a starting number of 0.
        }
    return 0;
}
